...
//    File p = new File("/DoAnOOP/src/DoAnOOPJava/nhanvien.txt");
//    try {
...
//          new FileOutputStream("/DoAnOOPV2/src/DoAnOOPJava/DataNhanVien.txt", true));
...
//      pw.println();
//      pw.append(
//          nv.getManv() + "  " + nv.getHoten() + "  " + nv.getNgaysinh() + "  " //+ //Integer.toString(
//              //nv.getLuong()));
//          );
//      pw.flush();
//      pw.close();
...
//    System.out.printf("%-20s %-20s %-20s %-20s %-20s", "Mã nhân viên", "Họ tên",
//        "Ngày tháng năm sinh", "Lương", "Chức vụ");
//    System.out.println();
